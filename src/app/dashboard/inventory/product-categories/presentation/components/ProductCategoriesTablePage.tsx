...
export function ProductCategoriesTablePage() {
  ...
  return (
    <>
      <PageHeader pageHeader={productCategoriesHeader} />

      <Show
        when={!isLoading}
        fallback={<TableSkeleton columns={columnsProductCategories.length} />}
      >
        <MainDataTable
      ...
      <ExcelImportDialog
        ...
        title="Importar categorías de productos desde excel"
        onSuccess={() => {}}
      />
    </>
  );
