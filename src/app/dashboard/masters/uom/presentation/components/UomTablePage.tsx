...
import { columnsUom } from "./columns-uom";
import { uomFormConfig } from "../forms/uom-form.config";
...
export function UomTablePage() {
  ...
  return (
    <>
      <PageHeader pageHeader={uomHeader} />

      <Show
        when={!isLoading}
        fallback={<TableSkeleton columns={columnsUom.length} />}
      >
        <MainDataTable
      ...
      <CrudFormDialog
        ...
        title={editingItem ? "Editar Unidad de Medida" : "Crear Unidad de Medida"}
        formConfig={uomFormConfig}
        defaultValues={
          editingItem
